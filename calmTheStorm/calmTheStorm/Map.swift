...
//        AnnotatedItem(name: "Tornado Shelter", coordinate: .init(latitude: 47.6848, longitude: -122.1883)),
//        AnnotatedItem(name: "Volcano Shelter", coordinate: .init(latitude: 47.48, longitude: -122.22)),
